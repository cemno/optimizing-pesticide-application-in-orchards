...
In the following chapter we show and explain the code of our model chunk by chunk.
...
Since looking at the outcome of the 10 year model only is not enough to make an
educated recommendation, we utilize the Monte Carlo simulation (`mcSimulation()`).
We set the `numberOfModelRuns` for our purpose to 10 000. This should <br>
