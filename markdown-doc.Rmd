...
digraph {
  ...
  # Add node group {Intervention & Alternatives} specific statements and group the nodes
  # ---------
  node [fontsize = 20,
        fixedsize = true,
        width = 3,
  ...
  subgraph {
    ...
    Al1 [label = 'Alternative1'];
    Al2 [label = 'Alternative2']
  }
  # ---------
  
  # Add node group {Pesticides & Cost} specific statements and group the nodes
  # --------- 
  node [fontsize = 20,
        fixedsize = true,
        width = 3,
