...
knitr::write_bib(c(.packages(),
                   'knitr', 'decisionSupport', 'ggplot2', 'DiagrammR', 'tidyverse', 'DiagrammeRsvg', 'rsvg'), 'bib/packages.bib')
```
---
nocite: '@*'
---
...
biodiversity - and the customer behaviour.
...
only is a reduction economically favourably on a farm level, but more and more 
...
```{r echo=FALSE, out.width="100%", cache=FALSE,fig.cap=""}
# Plot flow chart 
model_flow_chart
