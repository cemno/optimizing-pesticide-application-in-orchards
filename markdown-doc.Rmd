...
ascs_decision_model <- function(x, varnames){
  ...
  machine_man_cost <- c( initial_man_cost, rep( 0, (n_years-1) ) )
  machine_aut_cost <- c( initial_auto_cost, rep( 0, (n_years-1) ) )
  ...
  farmers_profit_man = (fruit_sales_e_ha_man - pest_cost_ha_man) * area_per_machine - machine_man_cost
  farmers_profit_aut = (fruit_sales_e_ha_aut - pest_cost_ha_aut) * area_per_machine - machine_aut_cost
