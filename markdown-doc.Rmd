...
ascs_decision_model <- function(x, varnames){
  ...
  for (y in 1:n_years) {
    if (y == 1) {
      rel_water_cont_man <- c(1)
      rel_water_cont_aut <- c(1)
      rel_bio_man <- c(1)
      rel_bio_aut <- c(1)
      
      plant_dmg_pot_man <- vv( potential_plant_damage, var_CV, 1 )
      plant_dmg_pot_aut <- plant_dmg_pot_man
      
      actual_plant_dmg_man <- plant_damage_pot - pest_quant_man
      actual_plant_dmg_aut <- plant_damage_pot - pest_quant_aut / pest_red_fact
      
    } else {
      rel_water_cont_man <- rel_water_cont_man + ((1 - pest_quant_man)*0.1)
      rel_water_cont_aut <- rel_water_cont_aut + ((1 - pest_quant_aut)*0.1)
      rel_bio_man <- rel_biodiversity_man + ((1 - pest_quant_man)*0.1)
      rel_bio_aut <- rel_biodiversity_aut + ((1 - pest_quant_aut)*0.1)
      
      plant_dmg_pot_man <- (vv(potential_plant_damage,var_CV,1)) + (rel_water_cont_man + rel_bio_man)
      plant_dmg_pot_aut <- plant_dmg_pot_man + (rel_water_cont_aut + rel_bio_aut)
      
      actual_plant_dmg_man <- plant_damage_pot_man - pest_quant_man
      actual_plant_dmg_man <- ifelse(actual_plant_dmg_man<0,0,actual_plant_dmg_man)
      actual_plant_dmg_aut <- plant_damage_pot_aut - pest_quant_aut / pest_red_fact
