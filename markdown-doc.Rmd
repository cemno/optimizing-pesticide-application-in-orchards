...
ascs_decision_model <- function(x, varnames){
  ...
  rel_water_cont_man <- rel_water_cont_dec + ((pest_quant_aut - government_pesticide_quantity)*0.1)
  rel_water_cont_aut <- rel_water_cont_dec + ((pest_quant_man - government_pesticide_quantity)*0.1)
