...
ascs_decision_model <- function(x, varnames){
  ...
  for (y in 1:n_years) {
    ...
    if (y == 1) {
      ...
      # manuell correlation between pesticide quantity and potential plant damage
      auxiliary_table$pest_quant_man <- auxiliary_table$plant_dmg_pot_man * rnorm(n_years, 1, 0.05) 
      ...
      if(auxiliary_table$gov_inter_happened_man[y-1] == 0) {
        if ( (y + auxiliary_table$gov_reaction[y] <= n_years) & 
          ...
          {
          auxiliary_table$gov_inter_happened_man[y + auxiliary_table$gov_reaction[y]] <- chance_event(auxiliary_table$gov_inter_chance_man[y],
                                                                                                   1, 0, 1)
        }
      ...
      if (auxiliary_table$gov_inter_happened_aut[y-1] == 0) {
        if ( (y + auxiliary_table$gov_reaction[y] <= n_years) & 
             (auxiliary_table$gov_reaction[y + auxiliary_table$gov_reaction[y]] == 0) ) 
        {
          auxiliary_table$gov_inter_happened_aut[y + auxiliary_table$gov_reaction[y]] <- chance_event(auxiliary_table$gov_inter_chance_aut[y],
                                                                                                   1, 0, 1)
        }
