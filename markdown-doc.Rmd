...
# input_table <- as.estimate(input_table, correlation_matrix = input_table_cor1)
...
# correlation_matrix
# write.csv(correlation_matrix, "data/final/inputs_cor.csv")
# input_table_cor <- read.csv("data/final/inputs_cor.csv")
