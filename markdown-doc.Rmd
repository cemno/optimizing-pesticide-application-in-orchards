...
ascs_decision_model <- function(x, varnames){
  ...
  farmers_profit_man = (fruit_sales_e_ha_man - pest_cost_ha_man) * area_per_machine - machine_cost_man
  farmers_profit_aut = (fruit_sales_e_ha_aut - pest_cost_ha_aut) * area_per_machine - machine_cost_aut
