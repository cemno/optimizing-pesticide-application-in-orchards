...
plot_pls(pls_result, input_table = data.frame(variable = input_table$variable, label = input_table$label), threshold = 0)
...
#                                    base_size = 7) 
# 
# ggsave(filename = "images/compound_figure2.png", plot = compound_fig, width = 7, height = 5)
